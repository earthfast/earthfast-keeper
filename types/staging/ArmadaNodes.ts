...
export interface ArmadaNodesInterface extends utils.Interface {
  functions: {
...
export interface ArmadaNodes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArmadaNodesInterface;
