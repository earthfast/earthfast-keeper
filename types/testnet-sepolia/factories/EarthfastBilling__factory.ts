...
export class EarthfastBilling__factory {
  static readonly abi = _abi;
  static createInterface(): EarthfastBillingInterface {
    return new utils.Interface(_abi) as EarthfastBillingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EarthfastBilling {
    return new Contract(address, _abi, signerOrProvider) as EarthfastBilling;
  }
}
